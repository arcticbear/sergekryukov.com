...
// для этого зайтите по адресу сайта плюс /@sync


// ИНТЕРФЕЙС
  
// использовать логичный, но более привычный порядок ссылок влево-вправо
...
// показывать ли замочек для входа всем
  $_config['visible_login'] = true; /* bool */
