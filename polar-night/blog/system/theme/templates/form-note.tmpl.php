...
<div class="form-control">
  ...
  <div class="form-subcontrol">
    ...
    <p class="small baseline">
      ...
      <span id="livesave-button" class="keyboard-shortcut" title="Несохранённые изменения" style="display: none"><?= _SHORTCUT ('livesave')? _SHORTCUT ('livesave') : 'Сохранить' ?></span>
    ...
    <div id="e2-uploaded-image-prototype" style="float: left; margin-right: 1em; margin-bottom: 1em; display: none">
      <div style="position: relative">
        <a class="uploaded-image-preview" href="javascript:return(false)"><img class="uploaded-image-preview" src="" alt="" /></a>
        <div style="position: absolute; right: -5px; bottom: -5px">
          <a class="uploaded-image-remover" style="display: none" href=""><img src="<?= _IMGSRC ('remove.png') ?>" alt="Убрать" style="margin: -4px -3px -3px"  /></a>
        </div>
      </div>
    </div>
    ...
    <? foreach ($content['form-note']['images'] as $image) { ?>
      <div style="float: left; height: 80px; margin-right: 1em; margin-bottom: 1em"><img class="uploaded-image-preview" src="<?= $image['thumb'] ?>" alt="<?= $image['name'] ?>" /><a href="javascript:return(false)"></a>
      </div>
    <? } ?>
    </div>
    
    <p id="e2-upload-controls" class="admin-links" style="height: 24px; display: none"><a href="javascript:" id="e2-upload-button"><img src="<?= _IMGSRC ('attach.gif') ?>" alt="@" title="Добавить рисунок" align="middle" width="24" height="24" /></a><img class="ajaxload" id="e2-uploading" src="<?= _IMGSRC ('loading-spinner.gif') ?>" alt="" style="display: none" /><br /></p>

    <!--
    <div id="e2-uploaded-files" style="clear: left">
    </div>
    -->
